...
class Unet(nn.Module):
    def __init__(self, num_classes=21, in_channels=3, pretrained=False):
        ...
        # 128,128,256
        self.up_concat3 = unetUp(in_filters[2], out_filters[2])  # 768 256
        # 256,256,128
        self.up_concat2 = unetUp(in_filters[1], out_filters[1])  # 384 128
        # 512,512,64
        self.up_concat1 = unetUp(in_filters[0], out_filters[0])  # 192 64

        # final conv (without any concat)
        self.final = nn.Conv2d(out_filters[0], num_classes, 1)  # 64 21 1
...
if __name__ == "__main__":
    a = Unet(num_classes=21, in_channels=3, pretrained=False)
    print(a)
